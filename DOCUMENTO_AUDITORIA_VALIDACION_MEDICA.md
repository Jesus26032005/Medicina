...
Cada pulsación aumenta la presión normalizada entre 9 y 13 puntos según el caso. La presión cae automáticamente 4 puntos cada 140 ms y el estado se evalúa cada 500 ms.
...
 técnica = máximo(0, precisión_final − penalización_tisular − errores × 5)

El daño tisular descuenta 25 % de su valor en una finalización no crítica. Si alcanza 100 %, se considera error crítico, se aplica la penalización tisular completa y la puntuación total queda limitada a 25 puntos.
...
   
***Caso de prueba TRQ-03: presión insuficiente sostenida***
| | |
|-|-|
| **Entrada** | **Resultado esperado** |
| Presión simulada | Menor de 65 % |
| Permanencia insuficiente | Un error cada 1.8 s aproximadamente |
| Penalización | −5 puntos de técnica por error |
