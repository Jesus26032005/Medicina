    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 px-6 backdrop-blur-sm">
      <motion.section animate={{ opacity: 1, y: 0 }} className="w-full max-w-xl rounded-lg border border-slate-200 bg-white p-6 text-slate-950 dark:border-white/10 dark:bg-slate-900 dark:text-white" initial={{ opacity: 0, y: 18 }}>
        ...
        <div className="mt-6 flex flex-wrap justify-end gap-3">
          <button
            className="h-12 touch-manipulation select-none rounded-md bg-slate-900 px-4 text-sm font-semibold text-white transition hover:bg-slate-700 dark:bg-slate-700 dark:hover:bg-slate-600"
            onClick={onExit}
            type="button"
          >
            Salir al Dashboard
          ...
          <button
            className="h-12 touch-manipulation select-none rounded-md bg-cyan-600 px-4 text-sm font-semibold text-white transition hover:bg-cyan-700"
            onClick={onRestart}
            type="button"
          >
            Nuevo caso
