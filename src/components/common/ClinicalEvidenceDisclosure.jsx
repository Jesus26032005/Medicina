...
export const evidenceByModule = {
  ...
  tactical_triage: {
    ...
    links: [
      ...
      {
        institution: 'PubMed',
        note: 'Validez, concordancia y comparación del Manchester Triage System frente al Emergency Severity Index.',
      ...
      },
      {
        ...
        note: 'Sistema oficial de clasificación de urgencias por cinco niveles de prioridad.',
